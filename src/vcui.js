    ...
    extend(core, {
        ...
        info: function () {
            console.table({
                ...
                'js docs': {value: 'http://family.vinylc.com/reference/vcui/reference/script/jsdocs/index.html'},
                'download': {value: 'http://family.vinylc.com/reference/vcui/downloads/index.html'}
            });
        },
        /**
