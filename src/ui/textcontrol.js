...
(function ($, core, undefined) {
     ...
     * @fires common.ui.TextControl#textcontrolchange
     * @fires common.ui.TextControl#textcontrolresize
     * @example
    ...
    var TextControl = ui('TextControl', /** @lends common.ui.TextControl# */{
        ...
        initialize: function (el, options) {
            ...
            me.on('keydown keyup cut paste blur', function(e) {
                ...
                /**
                 * 텍스트가 변경됐을 때 발생
                 * @event common.ui.TextControl#textcontrolchange
                 * @type {Object}
        ...
        _layout: function(me, $el, $clone, initialHeight, offset) {
             ...
             * @event common.ui.TextControl#textcontrolresize
             */
