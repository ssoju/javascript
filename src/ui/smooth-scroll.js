/*!
 * Customized by comahead@vi-nyl.com(김승일) on 2015-05-20.
    ...
    var SmoothScroll = core.ui('SmoothScroll', {
        ...
        _wheel: function(e) {
            ...
            if (me.wheelTimeout === undefined) {
                me._startX = me.x;
                me._startY = me.y;
                me.triggerHandler('smoothscrollstart', {
                    x: me.x,
                    y: me.y
                });
            }
        ...
        _translate: function(x, y) {
            ...
            me.x = x;
            me.y = y;
            me.triggerHandler('smoothscrollmove', {
                x: me.x,
                y: me.y
            });
        },
        ...
        _move: function(e) {
            ...
            if (!me.directionLocked && !me.options.freeScroll) {
                if (absDistX > absDistY + me.options.directionLockThreshold) {
                    me.directionLocked = 'h';
                    // lock horizontally
                } else if (absDistY >= absDistX + me.options.directionLockThreshold) {
                    me.directionLocked = 'v';
                    // lock vertically
                } else {
                    me.directionLocked = 'n';
                    // no lock
                }
            }
        ...
        _end: function(e) {
            ...
            if (me.options.momentum && duration < 300) {
                momentumX = me.hasHorizontalScroll ? momentum(me.x, me.startX, duration, me.maxScrollX, me.options.bounce ? me.wrapperWidth : 0, me.options.deceleration) : {
                    destination: newX,
                    duration: 0
                };
                momentumY = me.hasVerticalScroll ? momentum(me.y, me.startY, duration, me.maxScrollY, me.options.bounce ? me.wrapperHeight : 0, me.options.deceleration) : {
                    destination: newY,
                    duration: 0
                };
        ...
        refresh: function() {
            //var rf = this.$wrapper[0].offsetHeight;
            // Force reflow
            var me = this;
        ...
        _snap: function() {
            ...
            if (me._isSnap) {
                ...
                me._isSnap = true;
                x && $.each(me.snapItemsPos, function(i, item) {
                    var left = item.left;
                    if (x > 0) {
        ...
        _triggerEnd: function() {
            ...
            if (me.options.snap && me._snap() === true) {
                return;
            }
