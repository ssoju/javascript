/*!
 * @mdule scui.ui.ResponseCarousel
...
(function ($, core) {
    ...
    var ResponseCarousel = core.ui('ResponseCarousel', {
        ...
        _bindEvents: function () {
            ...
            me.options.autoPlay && me.on('mouseenter touchstart mouseleave touchend touchcancel focusin focusout', function(e) {
                switch(e.type) {
                    case 'mouseenter':
                    case 'touchstart':
                    case 'focusin':
        ...
        /**
         * 페이지 이동
         * @param {number} newIndex 이동할 페이지 인덱스
         * @param {boolean} isAni 애니메이션 동작 여부
         */
        ...
        _refresh: function () {
            ...
            me.conWidth = me.$el.width();                               // 컨테이너 너비
            me.itemWidth = Math.floor(me.conWidth / me.perCount);   // 아이템 너비
            me.itemHeight = me.$items.eq(0).height();                  // 아이템 두께
            me.totalPage = Math.ceil(me.totalCount / me.perCount);  // 총 페이지 수
            me.totalWidth = (me.itemWidth * me.totalCount);         // 총 스크롤 너비
