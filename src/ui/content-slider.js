...
(function ($, core, undefined) {
	...
	var ContentSlider = core.ui('ContentSlider', {
		bindjQuery: 'ContentSlider',
		defaults: {
		...
		_buildContentSlide: function () {
			...
			me.$contentSlide.on('smoothscrollstart', function (e) {
				if (me.isSliding) {e.preventDefault(); return; }
				me.isSliding = true;
		...
		_contentSlideEnd: function (index) {
			...
			me.$contentSlide.triggerHandler('contentslideend', {index:index, target: me.$contentPanels.get(index)});
		},
	...
	if (typeof define === "function" && define.amd) {
		define('modules/content-slider', [], function() {
