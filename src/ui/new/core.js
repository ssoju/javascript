...
(function ($) {
    ...
    /**
     * ui 네임스페이스
     * 더불어, coma.ui.View에서 상속받아 새로운 UI모듈을 생성해준다.
     * @namespace
     * @name coma.ui
     * @example
     * var Tab = coma.ui('Tab', {
...
// 숨겨진 후에 열었던 원래버튼에 포커스를 강제로 준다.
    ...
    var doc = document,
         ...
         * @returns {*}
         * @example
         * coma.each({'a': '에이', 'b': '비', 'c': '씨'}, function(value, key) {
    ...
    extend(core, {
        ...
        /**
         * coma 하위에 name에 해당하는 네임스페이스를 생성하여 object를 설정해주는 함수
         *
         * @function
         * @name coma.addon
         *
         * @param {string} name .를 구분자로 해서 coma을 시작으로 하위 네임스페이스를 생성. name이 없으면 coma에 추가된다.
...
/////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    core.addon('string', function () {
        ...
        return /** @lends coma.string */{
             ...
             *
             * @example
             * coma.string.cutByByte("동해물과", 3, "..."); // "동..."
             */
             ...
             * @example
             * coma.string.indexByByte("동해물과", 3); // 2
             */
             ...
             *
             * @example
             * coma.string.escapeHTML('<div><a href="#">링크</a></div>'); // "&lt;div&gt;&lt;a href=&quot;#&quot;&gt;링크&lt;/a&gt;&lt;/div&gt;"
             */
             ...
             *
             * @example
             * coma.string.unescapeHTML('&lt;div&gt;&lt;a href=&quot;#&quot;&gt;링크&lt;/a&gt;&lt;/div&gt;');  // '<div><a href="#">링크</a></div>'
             */
 ...
 */
         ...
         * @example
         * var obj = {"a": "A", "b": "B"}
         * coma.object.remove(obj, 'b'); // {"a":"A"} // delete obj.b;로 하는게 더 낫겠네..ㅎ
         */
...
// vanilla js~
         ...
         *
         * @example
         * coma.array.filter([1, '일', 2, '이', 3, '삼'], function(item, index) {
 *
 ...
 * });
         ...
         *
         * @example
         * coma.array.include([1, '일', 2, '이', 3, '삼'], '삼');  // true
         */
         ...
         *
         * @example
         * coma.array.indexOf([1, '일', 2, '이', 3, '삼'], '일');  // 1
         */
...
/////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    core.addon('date', function () {
        ...
        return /** @lends coma.date */{
             ...
             * @returns {number}
             * @example
             * coma.date.weekOfYear(new Date); // 2 // 2015-01-05를 기준으로 했을 때
             */
            weekOfYear: (function () {
             ...
             * @returns {number} dates.ms 밀리초
             * @example
             * coma.date.normalize(0, 0, 120, 0) // {day:0, hour: 0, min: 2, sec: 0, ms: 0} // 즉, 120초가 2분으로 변환
             */
...
/////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    core.addon(/** @lends coma */ {
         ...
         *
         * @example
         * coma.browser.isTouch // 터치디바이스 여부
         * coma.browser.isRetina // 레티나 여부
         * coma.browser.isMobile // orientation 작동여부로 판단
         * coma.browser.isMac // 맥OS
         * coma.browser.isLinux // 리눅스
         * coma.browser.isWin // 윈도우즈
         * coma.browser.is64Bit // 64비트 플랫폼
         *
         * coma.browser.isIE // IE
         * coma.browser.ieVersion // IE의 버전
         * coma.browser.isOpera // 오페라
         * coma.browser.isChrome // 크롬
         * coma.browser.isSafari // 사파리
         * coma.browser.isWebKit // 웹킷
         * coma.browser.isGecko // 파이어폭스
         * coma.browser.isIETri4 // IE엔진
         * coma.browser.isAir // 어도비 에어
         * coma.browser.isIOS // 아이폰, 아이패드
         * coma.browser.isAndroid // 안드로이드
         * coma.browser.iosVersion // ios 버전 : [8, 1, 0] -> [major, minor, revision]
         * coma.browser.androidVersion // android 버전 : [4, 1, 0] -> [major, minor, revision]
         * @example
 ...
 *  }, 500));
         ...
         * coma.toArray(arguments);  // arguments를 객체를 array로 변환하여 Array에서 지원하는 유틸함수(slice, reverse ...)를 쓸수 있다.
         */
...
////////////////////////////////////////////////////
    ...
    /**
     * 루트클래스로서, coma.Base나 coma.Class를 이용해서 클래스를 구현할 경우 coma.Base를 상속받게 된다.
     * @class
     * @name coma.Base
     * @example
     * var Person = coma.Base.extend({  // 또는 var Person = coma.Class({ 으로 구현해도 동일하다.
*
...
//////////////////////////////////////////////
        ...
        /**
         * 클래스를 생성해주는 함수(coma.Base.extend 별칭)
         * @param {Object} attr 메소드 모음 객체
         * @returns {coma.Base} 새로운 객체
         * @example
...
(function ($, core) {
    ...
    core.addon('util', function () {
        ...
        return /** @lends coma.util */{
            ...
            /**
             * 팝업을 띄우는 함수. (coma.openPopup으로도 사용가능)
             * @param {string} url 주소
...
//var winCoords = coma.util.popupCoords(width, height),
             ...
             * @example
             * coma.util.resizeToContent(); // 팝업에서만 사용
             */
...
// 기존에 UI모듈이 빌드된 요소들이 ajax 에 의해,
// 교체되거나 삭제된 DOM에 대해서 주기적으로 메모리해제, 이벤트 언바인딩 등을 시켜준다.
