    ...
    extend(core, {
        ...
        info: function() {
            console.table({
                ...
                'copyright': {
                    value: 'VinylC UID Group'
                },
                'componentPrefix': {
                    value: this.UI_PREFIX
                },
                'debug': {
                    value: this.IS_DEBUG
                },
                'company': {
                    value: 'http://c.vi-nyl.com'
                },
                'reference': {
                    value: 'http://family.vinylc.com/reference/'
                },
                'js docs': {
                    value: 'http://family.vinylc.com/reference/vcui/reference/script/jsdocs/index.html'
                },
                'download': {
                    value: 'http://family.vinylc.com/reference/vcui/downloads/index.html'
                }
            });
        },
        /**
...
(function($, core, global, undefined) {
    ...
    var View = core.BaseClass.extend( /** @lends vcui.ui.View# */ {
        ...
        tmpl: function(id, data) {
            ...
            if (!this._tmplCached[id]) {
                this._tmplCached[id] = core.template(this.templates[id]);
            }
