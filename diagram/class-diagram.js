d3.classDiagram = (function() {
  ...
  function createClasses(classes) {
    var g = svg.selectAll('g.class')
      ...
      .attr({
        id: function(d) { return encodeClassName(d.classname) + 'Class'; },
        'class': 'class',
    ...
    var classNameTexts = classNameG.append('text')
      ...
      .call(d3.multilineText()
        ...
        .paddingTop(4)
        .paddingBottom(4)
        .text(function(d) { return decodeClassName(d.classname); })
      );
    ...
    var boxes = {
      get: function(name) {
          return this[encodeClassName(name)];
      }
    };
    svg.selectAll('g.class')
      .each(function(d, i) {
        ...
        boxes[encodeClassName(d.classname)] = new d3.classDiagram.Box(d.x, d.y, bbox.width, bbox.height);
      });
